...
export function POST(_request: Request, context: { params: Promise<{ listingId: string }> }) {
  return forwardMutation("POST", context);
}

export function DELETE(_request: Request, context: { params: Promise<{ listingId: string }> }) {
