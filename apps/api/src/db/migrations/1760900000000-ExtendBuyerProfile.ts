  ...
  async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
      ALTER TABLE buyer_profiles
        ...
        ADD CONSTRAINT chk_buyer_preferred_fuel_types
          CHECK (preferred_fuel_types <@ ARRAY['PETROL', 'DIESEL', 'HYBRID', 'ELECTRIC', 'OTHER']::text[]),
        ADD CONSTRAINT chk_buyer_preferred_transmissions
          CHECK (preferred_transmissions <@ ARRAY['AUTOMATIC', 'MANUAL', 'CVT', 'DSG']::text[]),
  ...
  async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
      ALTER TABLE buyer_profiles
        ...
        DROP CONSTRAINT chk_buyer_preferred_transmissions,
        DROP CONSTRAINT chk_buyer_preferred_fuel_types,
